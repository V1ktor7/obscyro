...
import scenarioOverrideRoutes from "./routes/scenario-overrides.js";
...
import labModelRoutes from "./routes/lab-models.js";
...
await app.register(labModelRoutes, { prefix: "/v1" });
await app.register(datasetRoutes, { prefix: "/v1" });
await app.register(homeRoutes, { prefix: "/v1" });
await app.register(connectivityRoutes, { prefix: "/v1" });
await app.register(lineageRoutes, { prefix: "/v1" });
await app.register(pipelineRoutes, { prefix: "/v1" });
await app.register(scenarioOverrideRoutes, { prefix: "/v1" });
await app.register(geoRoutes, { prefix: "/v1" });
await app.register(signalRoutes, { prefix: "/v1" });
